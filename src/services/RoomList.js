...
const isMEventSpaceChild = (mEvent) => {
  return (
 ...
 */
const waitFor = async (callback, timeout = 400, maxTry = -1) => {
    ...
    this.matrixClient.on(
      ...
      async (room, membership, prevMembership) => {
        ...
        if (membership === 'invite') {
          ...
          console.log('invitelist updated');
        ...
        if (this.mDirects.has(roomId) && membership === 'join') {
          console.log('rooom join eventtttttttttttttttttttttttttttttt');
