const cons = {
  version: '2.1.3',
  secretKey: {
    ACCESS_TOKEN: 'biples_access_token',
    DEVICE_ID: 'biples_device_id',
    USER_ID: 'biples_user_id',
    BASE_URL: 'biples_hs_base_url',
  },
  DEVICE_DISPLAY_NAME: 'Biples Web',
  IN_BIPLES_SPACES: 'in.biples.spaces',
  tabs: {
    HOME: 'home',
    DIRECTS: 'dm',
  },
