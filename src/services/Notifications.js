...
import LogoSVG from 'assets/svg/cinny-unread.svg';
import LogoUnreadSVG from 'assets/svg/cinny-unread.svg';
import LogoHighlightSVG from 'assets/svg/cinny-highlight.svg';
import { cssColorMXID } from 'utils/colorMXID';
import { setFavicon } from 'utils/common';
import renderAvatar from 'utils/render';
import cons from './cons';
import navigation from './navigation';
import settings from './settings';

const isNotifEvent = (mEvent) => {
...
const findMutedRule = (overrideRules, roomId) => {
